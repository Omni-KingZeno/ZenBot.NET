...
{
    public const string LZAGameVersion = "1.0.2";
    ...
    public IReadOnlyList<long> TextSpeedPointer                 { get; } = [0x5F0C250, 0xD8, 0x40];
    public IReadOnlyList<long> MyStatusPointer                  { get; } = [0x5F0C250, 0xA0, 0x40];
    public IReadOnlyList<long> PartyPointer                     { get; } = [0x5F0C250, 0x18, 0x1B0, 0xF0, 0x50, 0x30, 0x0];
    public IReadOnlyList<long> CurrentBoxPointer                { get; } = [0x5F0C250, 0xA8, 0x596];
    ...
    public IReadOnlyList<long> LinkTradeCodeLengthPointer       { get; } = [0x5F36A98, 0x52];
    public IReadOnlyList<long> LinkTradeCodePointer             { get; } = [0x5F36A98, 0x30, 0x0];
    ...
    public const uint MenuOffset      = 0x5F2E880;
    public const uint ConnectedOffset = 0x5F33DD8;
